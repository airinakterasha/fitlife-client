...
const TestimonialsComp = ({testimoni}) => {
    const {reviewUser, reviewerMail, reviewerImage, reviewFeedback, reviewRating} = testimoni;
            ...
            <div className="relative p-6">
                <figure className="relative z-10">
                    ...
                    <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        ...
                        <span
                            className="flex gap-1 text-amber-400 text-2xl"
                            role="img"
                            aria-label={`Rating: ${reviewRating} out of 5 stars`}
                        >
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                            ...
                            alt={reviewUser}
                            title={reviewUser}
                            className="max-w-full rounded-full shrink-0 w-12 h-12"
                            />
                            <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">{reviewUser}</span>
                            <cite className="not-italic">
                                <a href="http://www.microsoft.com">{reviewerMail}</a>
                            </cite>
                            </div>
                        </div>
                    </figcaption>
