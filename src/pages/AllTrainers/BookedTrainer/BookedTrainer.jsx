...
const BookedTrainer = () => {
  ...
  const {_id, name, slotName, trainerImage, slotTime, classes, email, age, profileImage, skills, role, availableDay, availableTime, status} = bookingTrainer;
  return (
    <>
        <Helmet>
        ...
        <div className="">
            <div className="">
                <div className="py-10">
                  <TitleSection heading={`Booked ${name}`} subHeading={`Book the trainer`}></TitleSection>
                </div>
                {/* profile */}
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="space-y-1">
                        <span className="flex items-center space-x-2">
                          ...
                          <span className="dark:text-gray-600 capitalize">{slotName} - {slotTime}</span>
                        </span>
