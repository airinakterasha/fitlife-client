  ...
  return (
    <>
        <footer className="py-6 dark:bg-gray-100 dark:text-gray-900">
          <hr className="" />
          <div className="container px-6 mx-auto divide-y dark:divide-gray-600 md:space-y-12">       
              <div className="grid pt-6 lg:justify-between">
                  <Link to='/'
                    id="WindUI"
                  ...
                  >
                    <span className=" font-bold text-2xl py-2">
                      <span className="text-[#F23B3F]">Fit</span>Life
                    </span>
                  </Link>
                  <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 mt-4"> 
                  ...
                  <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                      ...
                      <a rel="noopener noreferrer" href="https://twitter.com/" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-600 dark:text-gray-50">
                      ...
                      <a rel="noopener noreferrer" href="https://github.com/" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-600 dark:text-gray-50">
