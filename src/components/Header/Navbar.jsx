        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            >
              ...
              {/* dashboard start */}
              {
                  user && singleuser?.role=='admin' && <li role="none" className="flex items-stretch">
              ...
              {
                  user && singleuser?.role=='trainer' && <li role="none" className="flex items-stretch">
              ...
              {
                  user && singleuser?.role=='member' && <li role="none" className="flex items-stretch">
